...
public class DispensingTicketState implements ParkingMeterState {
    ...
    public void dispenseTicket() {
        ...
        System.out.println("Dispensing parking ticket for " + ParkingMeterContext.getInstance().getSelectedDuration() + " hours.");
        ParkingMeterContext.getInstance().setState(new IdleState());
    }
}
